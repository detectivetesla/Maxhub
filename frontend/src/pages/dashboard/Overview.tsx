        ...
        const fetchDashboardData = async () => {
            try {
                ...
                const [statsRes, ordersRes, fundingRes] = await Promise.all([
                    axios.get('http://localhost:5000/dashboard/stats', { headers }),
                    axios.get('http://localhost:5000/dashboard/orders', { headers }),
                    axios.get('http://localhost:5000/dashboard/transactions', { headers })
                ]);
